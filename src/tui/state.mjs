...
export const AGENTS = [
  ...
  { file: 'pm.md', name: 'pm', description: 'Product Manager', default: true },
  { file: 'researcher.md', name: 'researcher', description: 'Evidence Researcher', default: true },
  { file: 'dependency.md', name: 'dependency', description: 'Dependency Contract Validator', default: true },
  { file: 'architect.md', name: 'architect', description: 'System Architect', default: true },
  { file: 'developer.md', name: 'developer', description: 'Senior Developer', default: true },
  { file: 'reviewer.md', name: 'reviewer', description: 'Security & Compliance Reviewer', default: true },
  { file: 'qa.md', name: 'qa', description: 'Multimodal QA Engineer', default: true },
  { file: 'docs.md', name: 'docs', description: 'Continuous Documentarian', default: true },
  { file: 'deploy.md', name: 'deploy', description: 'DevOps & Release Engineer', default: true },
  { file: 'hotfix.md', name: 'hotfix', description: 'Production Hotfix Specialist', default: true },
];
